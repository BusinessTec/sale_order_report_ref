...
================================
Calculates sales orders amount in ref currency (can be any currency) and company currency plus the same with invoices. All calculation done at exchange rate of the order date.
    """,
